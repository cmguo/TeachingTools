...
class ConanConfig(QtConanFile):
    ...
    git_url = "git@git.100tal.com:epg_xhb_solution/talcloud_khaos_teachingtools.git"
    git_branch = "develop/master"

    description = "TeachingTools Library"

    requires = "QtComposition/master@cmguo/stable", "InkCanvas/master@cmguo/stable", "qtpromise/v0.5.0@cmguo/stable", "ShowBoard/develop@cmguo/test", "PageBox/develop@cmguo/test"
